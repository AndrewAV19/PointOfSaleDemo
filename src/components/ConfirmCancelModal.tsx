...
interface ConfirmDialogProps {
  ...
  readonly severity?: "error" | "warning" | "info" | "primary";
    ...
    <Dialog
      ...
      sx={{
        ...
        "& .MuiDialog-paper": {
          ...
          background: "white",
          backgroundImage: `
            radial-gradient(at top left, ${alpha(
              severityConfig.color,
              0.03
            )} 0%, transparent 50%),
            radial-gradient(at top right, ${alpha(
              severityConfig.color,
              0.03
            )} 0%, transparent 50%),
            radial-gradient(at bottom left, ${alpha(
              severityConfig.color,
              0.02
            )} 0%, transparent 50%)
          `,
      ...
      <DialogTitle
        ...
        sx={{
          ...
          background: `linear-gradient(135deg, ${
            severityConfig.lightColor
          } 0%, ${alpha(severityConfig.lightColor, 0.7)} 100%)`,
        ...
        <Box display="flex" alignItems="center" gap={2}>
          <Box
            sx={{
              ...
              color: "white",
              boxShadow: `0 4px 12px ${alpha(severityConfig.color, 0.3)}`,
            }}
          >
            {severityConfig.icon}
          </Box>
          <Typography
            ...
            sx={{
              background: `linear-gradient(135deg, ${
                severityConfig.color
              } 0%, ${alpha(severityConfig.color, 0.8)} 100%)`,
              backgroundClip: "text",
